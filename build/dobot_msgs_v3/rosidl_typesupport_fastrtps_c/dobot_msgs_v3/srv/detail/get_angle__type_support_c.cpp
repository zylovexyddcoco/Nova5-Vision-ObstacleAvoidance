...
#include "dobot_msgs_v3/srv/detail/get_angle__rosidl_typesupport_fastrtps_c.h"
...
using _GetAngle_Request__ros_msg_type = dobot_msgs_v3__srv__GetAngle_Request;
...
size_t get_serialized_size_dobot_msgs_v3__srv__GetAngle_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetAngle_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_msgs_v3__srv__GetAngle_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v3
size_t max_serialized_size_dobot_msgs_v3__srv__GetAngle_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dobot_msgs_v3__srv__GetAngle_Request;
    is_plain =
      (
...
static size_t _GetAngle_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dobot_msgs_v3__srv__GetAngle_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, GetAngle_Request)() {
...
#include "rosidl_runtime_c/string.h"  // angle
#include "rosidl_runtime_c/string_functions.h"  // angle

// forward declare type support functions


using _GetAngle_Response__ros_msg_type = dobot_msgs_v3__srv__GetAngle_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: angle
  {
    const rosidl_runtime_c__String * str = &ros_message->angle;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: angle
  {
    ...
    if (!ros_message->angle.data) {
      rosidl_runtime_c__String__init(&ros_message->angle);
    }
    bool succeeded = rosidl_runtime_c__String__assign(
      &ros_message->angle,
      tmp.c_str());
    if (!succeeded) {
      fprintf(stderr, "failed to assign string into field 'angle'\n");
      return false;
    }
  }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v3
size_t get_serialized_size_dobot_msgs_v3__srv__GetAngle_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetAngle_Response__ros_msg_type * ros_message = static_cast<const _GetAngle_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_dobot_msgs_v3__srv__GetAngle_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dobot_msgs_v3
size_t max_serialized_size_dobot_msgs_v3__srv__GetAngle_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = dobot_msgs_v3__srv__GetAngle_Response;
    is_plain =
      (
...
static size_t _GetAngle_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dobot_msgs_v3__srv__GetAngle_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, GetAngle_Response)() {
...
// already included above
// #include "dobot_msgs_v3/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "dobot_msgs_v3/srv/get_angle.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, GetAngle)() {
