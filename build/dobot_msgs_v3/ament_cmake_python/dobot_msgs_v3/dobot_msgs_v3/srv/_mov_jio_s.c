...
bool dobot_msgs_v3__srv__mov_jio__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v3.srv._mov_jio.MovJIO_Request", full_classname_dest, 41) == 0);
  }
  dobot_msgs_v3__srv__MovJIO_Request * ros_message = _ros_message;
  {  // x
...
PyObject * dobot_msgs_v3__srv__mov_jio__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v3.srv._mov_jio");
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_msgs_v3__srv__mov_jio__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v3.srv._mov_jio.MovJIO_Response", full_classname_dest, 42) == 0);
  }
  dobot_msgs_v3__srv__MovJIO_Response * ros_message = _ros_message;
  {  // res
