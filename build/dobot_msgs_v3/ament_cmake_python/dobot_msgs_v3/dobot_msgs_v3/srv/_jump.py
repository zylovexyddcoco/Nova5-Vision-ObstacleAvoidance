...
class Metaclass_Jump_Request(type):
    """Metaclass of message 'Jump_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__jump__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__jump__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__jump__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__jump__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__jump__request
...
class Jump_Request(metaclass=Metaclass_Jump_Request):
    """Message class 'Jump_Request'."""
...
class Metaclass_Jump_Response(type):
    """Metaclass of message 'Jump_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__jump__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__jump__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__jump__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__jump__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__jump__response
...
class Jump_Response(metaclass=Metaclass_Jump_Response):
    """Message class 'Jump_Response'."""
...
class Metaclass_Jump(type):
    """Metaclass of service 'Jump'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_msgs_v3.srv.Jump')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__jump

            from dobot_msgs_v3.srv import _jump
            if _jump.Metaclass_Jump_Request._TYPE_SUPPORT is None:
                _jump.Metaclass_Jump_Request.__import_type_support__()
            if _jump.Metaclass_Jump_Response._TYPE_SUPPORT is None:
                _jump.Metaclass_Jump_Response.__import_type_support__()


class Jump(metaclass=Metaclass_Jump):
    from dobot_msgs_v3.srv._jump import Jump_Request as Request
    from dobot_msgs_v3.srv._jump import Jump_Response as Response
