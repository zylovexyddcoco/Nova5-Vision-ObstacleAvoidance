...
class GetAngle_Response(metaclass=Metaclass_GetAngle_Response):
    ...
    def __init__(self, **kwargs):
        ...
        self.angle = kwargs.get('angle', str())
    ...
    def angle(self, value):
        if __debug__:
            assert \
                ...
                "The 'angle' field must be of type 'str'"
        self._angle = value
...
class Metaclass_GetAngle(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v3.srv import _get_angle
...
class GetAngle(metaclass=Metaclass_GetAngle):
    from dobot_msgs_v3.srv._get_angle import GetAngle_Request as Request
    from dobot_msgs_v3.srv._get_angle import GetAngle_Response as Response
