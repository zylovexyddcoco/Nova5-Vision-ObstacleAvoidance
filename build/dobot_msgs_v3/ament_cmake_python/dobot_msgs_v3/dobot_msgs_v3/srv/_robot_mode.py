...
class Metaclass_RobotMode(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v3.srv import _robot_mode
...
class RobotMode(metaclass=Metaclass_RobotMode):
    from dobot_msgs_v3.srv._robot_mode import RobotMode_Request as Request
    from dobot_msgs_v3.srv._robot_mode import RobotMode_Response as Response
