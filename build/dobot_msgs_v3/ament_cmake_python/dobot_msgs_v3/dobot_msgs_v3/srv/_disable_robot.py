...
class Metaclass_DisableRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v3.srv import _disable_robot
...
class DisableRobot(metaclass=Metaclass_DisableRobot):
    from dobot_msgs_v3.srv._disable_robot import DisableRobot_Request as Request
    from dobot_msgs_v3.srv._disable_robot import DisableRobot_Response as Response
