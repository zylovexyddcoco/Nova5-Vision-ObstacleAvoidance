...
bool dobot_msgs_v3__srv__rel_mov_l__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v3.srv._rel_mov_l.RelMovL_Request", full_classname_dest, 44) == 0);
  }
  dobot_msgs_v3__srv__RelMovL_Request * ros_message = _ros_message;
  {  // offset1
...
{
  /* NOTE(esteve): Call constructor of RelMovL_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v3.srv._rel_mov_l");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RelMovL_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_msgs_v3__srv__rel_mov_l__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v3.srv._rel_mov_l.RelMovL_Response", full_classname_dest, 45) == 0);
  }
  dobot_msgs_v3__srv__RelMovL_Response * ros_message = _ros_message;
  {  // res
...
{
  /* NOTE(esteve): Call constructor of RelMovL_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v3.srv._rel_mov_l");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RelMovL_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
