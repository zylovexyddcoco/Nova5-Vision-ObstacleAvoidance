...
class Metaclass_EmergencyStop(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_msgs_v3.srv.EmergencyStop')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dobot_msgs_v3.srv import _emergency_stop
...
class EmergencyStop(metaclass=Metaclass_EmergencyStop):
    from dobot_msgs_v3.srv._emergency_stop import EmergencyStop_Request as Request
    from dobot_msgs_v3.srv._emergency_stop import EmergencyStop_Response as Response
