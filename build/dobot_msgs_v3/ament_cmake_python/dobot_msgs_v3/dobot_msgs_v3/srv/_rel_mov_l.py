...
class Metaclass_RelMovL_Request(type):
    """Metaclass of message 'RelMovL_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__rel_mov_l__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__rel_mov_l__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__rel_mov_l__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__rel_mov_l__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__rel_mov_l__request
...
class RelMovL_Request(metaclass=Metaclass_RelMovL_Request):
    """Message class 'RelMovL_Request'."""
...
class Metaclass_RelMovL_Response(type):
    """Metaclass of message 'RelMovL_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__rel_mov_l__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__rel_mov_l__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__rel_mov_l__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__rel_mov_l__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__rel_mov_l__response
...
class RelMovL_Response(metaclass=Metaclass_RelMovL_Response):
    """Message class 'RelMovL_Response'."""
...
class Metaclass_RelMovL(type):
    """Metaclass of service 'RelMovL'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_msgs_v3.srv.RelMovL')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__rel_mov_l

            from dobot_msgs_v3.srv import _rel_mov_l
            if _rel_mov_l.Metaclass_RelMovL_Request._TYPE_SUPPORT is None:
                _rel_mov_l.Metaclass_RelMovL_Request.__import_type_support__()
            if _rel_mov_l.Metaclass_RelMovL_Response._TYPE_SUPPORT is None:
                _rel_mov_l.Metaclass_RelMovL_Response.__import_type_support__()


class RelMovL(metaclass=Metaclass_RelMovL):
    from dobot_msgs_v3.srv._rel_mov_l import RelMovL_Request as Request
    from dobot_msgs_v3.srv._rel_mov_l import RelMovL_Response as Response
