...
class Metaclass_RelMovJ_Request(type):
    """Metaclass of message 'RelMovJ_Request'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__rel_mov_j__request
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__rel_mov_j__request
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__rel_mov_j__request
            cls._TYPE_SUPPORT = module.type_support_msg__srv__rel_mov_j__request
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__rel_mov_j__request
...
class RelMovJ_Request(metaclass=Metaclass_RelMovJ_Request):
    """Message class 'RelMovJ_Request'."""
...
class Metaclass_RelMovJ_Response(type):
    """Metaclass of message 'RelMovJ_Response'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__rel_mov_j__response
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__rel_mov_j__response
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__rel_mov_j__response
            cls._TYPE_SUPPORT = module.type_support_msg__srv__rel_mov_j__response
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__rel_mov_j__response
...
class RelMovJ_Response(metaclass=Metaclass_RelMovJ_Response):
    """Message class 'RelMovJ_Response'."""
...
class Metaclass_RelMovJ(type):
    """Metaclass of service 'RelMovJ'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_msgs_v3.srv.RelMovJ')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._TYPE_SUPPORT = module.type_support_srv__srv__rel_mov_j

            from dobot_msgs_v3.srv import _rel_mov_j
            if _rel_mov_j.Metaclass_RelMovJ_Request._TYPE_SUPPORT is None:
                _rel_mov_j.Metaclass_RelMovJ_Request.__import_type_support__()
            if _rel_mov_j.Metaclass_RelMovJ_Response._TYPE_SUPPORT is None:
                _rel_mov_j.Metaclass_RelMovJ_Response.__import_type_support__()


class RelMovJ(metaclass=Metaclass_RelMovJ):
    from dobot_msgs_v3.srv._rel_mov_j import RelMovJ_Request as Request
    from dobot_msgs_v3.srv._rel_mov_j import RelMovJ_Response as Response
