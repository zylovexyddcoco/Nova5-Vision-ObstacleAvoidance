...
class Metaclass_RelMovJUser(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v3.srv import _rel_mov_j_user
...
class RelMovJUser(metaclass=Metaclass_RelMovJUser):
    from dobot_msgs_v3.srv._rel_mov_j_user import RelMovJUser_Request as Request
    from dobot_msgs_v3.srv._rel_mov_j_user import RelMovJUser_Response as Response
