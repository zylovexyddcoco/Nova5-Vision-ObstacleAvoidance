...
bool dobot_msgs_v3__srv__jump__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v3.srv._jump.Jump_Request", full_classname_dest, 36) == 0);
  }
  dobot_msgs_v3__srv__Jump_Request * ros_message = _ros_message;
  {  // offset1
...
{
  /* NOTE(esteve): Call constructor of Jump_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v3.srv._jump");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Jump_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_msgs_v3__srv__jump__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v3.srv._jump.Jump_Response", full_classname_dest, 37) == 0);
  }
  dobot_msgs_v3__srv__Jump_Response * ros_message = _ros_message;
  {  // res
...
{
  /* NOTE(esteve): Call constructor of Jump_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v3.srv._jump");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Jump_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
