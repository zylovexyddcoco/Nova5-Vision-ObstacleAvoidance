...
static const _SetCollisionLevel_Request_type_support_symbol_names_t _SetCollisionLevel_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, SetCollisionLevel_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v3, srv, SetCollisionLevel_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v3, srv, SetCollisionLevel_Request)() {
  return &::dobot_msgs_v3::srv::rosidl_typesupport_c::SetCollisionLevel_Request_message_type_support_handle;
}
...
static const _SetCollisionLevel_Response_type_support_symbol_names_t _SetCollisionLevel_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, SetCollisionLevel_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v3, srv, SetCollisionLevel_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v3, srv, SetCollisionLevel_Response)() {
  return &::dobot_msgs_v3::srv::rosidl_typesupport_c::SetCollisionLevel_Response_message_type_support_handle;
}
...
static const _SetCollisionLevel_type_support_symbol_names_t _SetCollisionLevel_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, SetCollisionLevel)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v3, srv, SetCollisionLevel)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v3, srv, SetCollisionLevel)() {
  return &::dobot_msgs_v3::srv::rosidl_typesupport_c::SetCollisionLevel_service_type_support_handle;
}
