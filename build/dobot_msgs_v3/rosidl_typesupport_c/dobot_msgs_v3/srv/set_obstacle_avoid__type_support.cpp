...
static const _SetObstacleAvoid_Request_type_support_symbol_names_t _SetObstacleAvoid_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, SetObstacleAvoid_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v3, srv, SetObstacleAvoid_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v3, srv, SetObstacleAvoid_Request)() {
  return &::dobot_msgs_v3::srv::rosidl_typesupport_c::SetObstacleAvoid_Request_message_type_support_handle;
}
...
static const _SetObstacleAvoid_Response_type_support_symbol_names_t _SetObstacleAvoid_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, SetObstacleAvoid_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v3, srv, SetObstacleAvoid_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v3, srv, SetObstacleAvoid_Response)() {
  return &::dobot_msgs_v3::srv::rosidl_typesupport_c::SetObstacleAvoid_Response_message_type_support_handle;
}
...
static const _SetObstacleAvoid_type_support_symbol_names_t _SetObstacleAvoid_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dobot_msgs_v3, srv, SetObstacleAvoid)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dobot_msgs_v3, srv, SetObstacleAvoid)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, dobot_msgs_v3, srv, SetObstacleAvoid)() {
  return &::dobot_msgs_v3::srv::rosidl_typesupport_c::SetObstacleAvoid_service_type_support_handle;
}
