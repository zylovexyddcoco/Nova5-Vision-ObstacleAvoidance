...
class Metaclass_AccJ(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v3.srv import _acc_j
...
class AccJ(metaclass=Metaclass_AccJ):
    from dobot_msgs_v3.srv._acc_j import AccJ_Request as Request
    from dobot_msgs_v3.srv._acc_j import AccJ_Response as Response
