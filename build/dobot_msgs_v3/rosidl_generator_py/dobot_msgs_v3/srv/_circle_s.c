...
bool dobot_msgs_v3__srv__circle__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v3.srv._circle.Circle_Request", full_classname_dest, 40) == 0);
  }
  dobot_msgs_v3__srv__Circle_Request * ros_message = _ros_message;
  {  // count
...
PyObject * dobot_msgs_v3__srv__circle__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v3.srv._circle");
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_msgs_v3__srv__circle__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v3.srv._circle.Circle_Response", full_classname_dest, 41) == 0);
  }
  dobot_msgs_v3__srv__Circle_Response * ros_message = _ros_message;
  {  // res
