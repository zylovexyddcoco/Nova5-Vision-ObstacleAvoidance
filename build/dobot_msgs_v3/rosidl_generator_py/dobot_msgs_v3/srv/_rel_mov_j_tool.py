...
class Metaclass_RelMovJTool(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v3.srv import _rel_mov_j_tool
...
class RelMovJTool(metaclass=Metaclass_RelMovJTool):
    from dobot_msgs_v3.srv._rel_mov_j_tool import RelMovJTool_Request as Request
    from dobot_msgs_v3.srv._rel_mov_j_tool import RelMovJTool_Response as Response
