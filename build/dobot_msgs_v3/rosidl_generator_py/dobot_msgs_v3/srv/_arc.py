...
class Metaclass_Arc_Response(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_msgs_v3.srv.Arc_Response')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_Arc(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v3.srv import _arc
...
class Arc(metaclass=Metaclass_Arc):
    from dobot_msgs_v3.srv._arc import Arc_Request as Request
    from dobot_msgs_v3.srv._arc import Arc_Response as Response
