...
class Metaclass_ServoP(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v3.srv import _servo_p
...
class ServoP(metaclass=Metaclass_ServoP):
    from dobot_msgs_v3.srv._servo_p import ServoP_Request as Request
    from dobot_msgs_v3.srv._servo_p import ServoP_Response as Response
