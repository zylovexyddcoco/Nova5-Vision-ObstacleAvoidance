...
#ifndef DOBOT_MSGS_V3__SRV__DETAIL__JUMP__FUNCTIONS_H_
#define DOBOT_MSGS_V3__SRV__DETAIL__JUMP__FUNCTIONS_H_
...
/// Create srv/Jump message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dobot_msgs_v3__srv__Jump_Request__init().
...
/// Destroy srv/Jump message.
/**
 * It calls
 * dobot_msgs_v3__srv__Jump_Request__fini()
...
/// Check for srv/Jump message equality.
/**
...
/// Initialize array of srv/Jump messages.
/**
...
/// Finalize array of srv/Jump messages.
/**
 * It calls
 * dobot_msgs_v3__srv__Jump_Request__fini()
...
/// Create array of srv/Jump messages.
/**
 * It allocates the memory for the array and calls
 * dobot_msgs_v3__srv__Jump_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/Jump messages.
/**
 * It calls
 * dobot_msgs_v3__srv__Jump_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/Jump message array equality.
/**
...
/// Copy an array of srv/Jump messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dobot_msgs_v3__srv__Jump_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_msgs_v3
...
/**
 * It calls
 * dobot_msgs_v3__srv__Jump_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_msgs_v3
...
/**
 * It allocates the memory for the array and calls
 * dobot_msgs_v3__srv__Jump_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_msgs_v3
...
/**
 * It calls
 * dobot_msgs_v3__srv__Jump_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DOBOT_MSGS_V3__SRV__DETAIL__JUMP__FUNCTIONS_H_
