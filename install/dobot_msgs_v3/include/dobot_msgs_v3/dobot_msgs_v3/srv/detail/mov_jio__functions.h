...
#ifndef DOBOT_MSGS_V3__SRV__DETAIL__MOV_JIO__FUNCTIONS_H_
#define DOBOT_MSGS_V3__SRV__DETAIL__MOV_JIO__FUNCTIONS_H_
 ...
 * calls
 * dobot_msgs_v3__srv__MovJIO_Request__init().
...
/**
 * It calls
 * dobot_msgs_v3__srv__MovJIO_Request__fini()
 ...
 * dobot_msgs_v3__srv__MovJIO_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * dobot_msgs_v3__srv__MovJIO_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * dobot_msgs_v3__srv__MovJIO_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_msgs_v3
...
/**
 * It calls
 * dobot_msgs_v3__srv__MovJIO_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_msgs_v3
...
/**
 * It allocates the memory for the array and calls
 * dobot_msgs_v3__srv__MovJIO_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_dobot_msgs_v3
...
/**
 * It calls
 * dobot_msgs_v3__srv__MovJIO_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // DOBOT_MSGS_V3__SRV__DETAIL__MOV_JIO__FUNCTIONS_H_
