...
{
  new (message_memory) dobot_msgs_v3::msg::RobotStatus(_init);
}

void RobotStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<dobot_msgs_v3::msg::RobotStatus *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotStatus_message_member_array[2] = {
  {
    ...
    offsetof(dobot_msgs_v3::msg::RobotStatus, is_enable),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(dobot_msgs_v3::msg::RobotStatus, is_connected),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotStatus_message_members = {
  ...
  2,  // number of fields
  sizeof(dobot_msgs_v3::msg::RobotStatus),
...
{
  return &::dobot_msgs_v3::msg::rosidl_typesupport_introspection_cpp::RobotStatus_message_type_support_handle;
}
