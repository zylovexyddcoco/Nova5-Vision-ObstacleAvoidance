...
class Metaclass_AccL(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v3.srv import _acc_l
...
class AccL(metaclass=Metaclass_AccL):
    from dobot_msgs_v3.srv._acc_l import AccL_Request as Request
    from dobot_msgs_v3.srv._acc_l import AccL_Response as Response
