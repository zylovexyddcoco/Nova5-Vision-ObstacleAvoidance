...
class Metaclass_GetHoldRegs(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v3.srv import _get_hold_regs
...
class GetHoldRegs(metaclass=Metaclass_GetHoldRegs):
    from dobot_msgs_v3.srv._get_hold_regs import GetHoldRegs_Request as Request
    from dobot_msgs_v3.srv._get_hold_regs import GetHoldRegs_Response as Response
