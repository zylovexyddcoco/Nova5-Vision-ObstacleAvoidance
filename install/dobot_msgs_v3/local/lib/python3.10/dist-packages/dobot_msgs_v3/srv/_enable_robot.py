...
class Metaclass_EnableRobot(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v3.srv import _enable_robot
...
class EnableRobot(metaclass=Metaclass_EnableRobot):
    from dobot_msgs_v3.srv._enable_robot import EnableRobot_Request as Request
    from dobot_msgs_v3.srv._enable_robot import EnableRobot_Response as Response
