...
class Metaclass_RelJointMovJ(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'dobot_msgs_v3.srv.RelJointMovJ')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from dobot_msgs_v3.srv import _rel_joint_mov_j
...
class RelJointMovJ(metaclass=Metaclass_RelJointMovJ):
    from dobot_msgs_v3.srv._rel_joint_mov_j import RelJointMovJ_Request as Request
    from dobot_msgs_v3.srv._rel_joint_mov_j import RelJointMovJ_Response as Response
