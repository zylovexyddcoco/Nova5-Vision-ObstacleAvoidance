...
bool dobot_msgs_v3__srv__rel_mov_j_tool__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v3.srv._rel_mov_j_tool.RelMovJTool_Request", full_classname_dest, 53) == 0);
  }
  dobot_msgs_v3__srv__RelMovJTool_Request * ros_message = _ros_message;
  {  // offset1
...
PyObject * dobot_msgs_v3__srv__rel_mov_j_tool__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v3.srv._rel_mov_j_tool");
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_msgs_v3__srv__rel_mov_j_tool__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v3.srv._rel_mov_j_tool.RelMovJTool_Response", full_classname_dest, 54) == 0);
  }
  dobot_msgs_v3__srv__RelMovJTool_Response * ros_message = _ros_message;
  {  // res
