...
class Metaclass_RelMovLUser(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from dobot_msgs_v3.srv import _rel_mov_l_user
...
class RelMovLUser(metaclass=Metaclass_RelMovLUser):
    from dobot_msgs_v3.srv._rel_mov_l_user import RelMovLUser_Request as Request
    from dobot_msgs_v3.srv._rel_mov_l_user import RelMovLUser_Response as Response
