...
bool dobot_msgs_v3__srv__inverse_solution__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v3.srv._inverse_solution.InverseSolution_Request", full_classname_dest, 59) == 0);
  }
  dobot_msgs_v3__srv__InverseSolution_Request * ros_message = _ros_message;
  {  // offset1
  ...
  {  // is_jointnear
    PyObject * field = PyObject_GetAttrString(_pymsg, "is_jointnear");
    if (!field) {
      return false;
    }
    assert(PyLong_Check(field));
    ros_message->is_jointnear = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // joint_near
...
PyObject * dobot_msgs_v3__srv__inverse_solution__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dobot_msgs_v3.srv._inverse_solution");
  ...
  {  // is_jointnear
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->is_jointnear);
    {
      int rc = PyObject_SetAttrString(_pymessage, "is_jointnear", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
...
ROSIDL_GENERATOR_C_EXPORT
bool dobot_msgs_v3__srv__inverse_solution__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dobot_msgs_v3.srv._inverse_solution.InverseSolution_Response", full_classname_dest, 60) == 0);
  }
  dobot_msgs_v3__srv__InverseSolution_Response * ros_message = _ros_message;
  {  // res
